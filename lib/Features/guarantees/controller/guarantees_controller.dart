...
abstract class GuaranteesController extends GetxController {
...
class GuaranteesControllerImpl extends GuaranteesController {
  final GuaranteesRepository _repository;

  List<EilmentModel> types = [];

  GuaranteesControllerImpl({required GuaranteesRepository repository})
