...
import 'package:apartment_admin/Features/guarantees/viewModel/viewModel.dart';
...
class GuaranteesEilmentViewPage extends StatefulWidget {
  const GuaranteesEilmentViewPage({super.key});

  @override
  State<GuaranteesEilmentViewPage> createState() => _EilmentViewPageState();
}

class _EilmentViewPageState extends State<GuaranteesEilmentViewPage> {
  GuaranteesElmentViewModel viewModel = GuaranteesElmentViewModel();
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<GuaranteesControllerImpl>(
        builder: (_) {
          return Padding(
