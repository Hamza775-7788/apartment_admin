...
import 'package:apartment_admin/Features/jops/viewModel/viewModel.dart';
...
class JopsEilmentViewPage extends StatefulWidget {
  const JopsEilmentViewPage({super.key});

  @override
  State<JopsEilmentViewPage> createState() => _EilmentViewPageState();
}

class _EilmentViewPageState extends State<JopsEilmentViewPage> {
  JopsElmentViewModel viewModel = JopsElmentViewModel();
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<JopsControllerImpl>(
        builder: (_) {
          return Padding(
