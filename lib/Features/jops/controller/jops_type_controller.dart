...
abstract class JopsController extends GetxController {
...
class JopsControllerImpl extends JopsController {
  final JopsTypeRepository _repository;

  List<EilmentModel> types = [];

  JopsControllerImpl({required JopsTypeRepository repository})
