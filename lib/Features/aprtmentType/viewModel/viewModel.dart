...
class ApartmentElmentViewModel {
  String title = "انواع التأجير";
  ...
  ApartmentTypeControllerImpl _controllerImpl = Get.put(
    getIt!<ApartmentTypeControllerImpl>(),
  );
