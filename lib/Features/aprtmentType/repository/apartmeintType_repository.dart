...
import 'package:apartment_admin/core/SERVER/apartment_type_link_api.dart';
...
abstract class ApartmentTypeRepository {
...
class ApartmeinttypeRepositoryImpl implements ApartmentTypeRepository {
  final NetworkInfo networkInfo;
  final GetConnect getConnect;

  ApartmeinttypeRepositoryImpl({
  ...
  Future<Either<Failure, List<EilmentModel>>> view() async {
    if (await networkInfo.isConnected) {
      final response = await getConnect.get(ApartmentTypeLinkApi.view);
